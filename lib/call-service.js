...
module.exports = (function(version, settings) {
  ...
  return new class {
    constructor() {
      ...
      if(!version) {
        throw new Error("CallService must be instantiated with a context.io api version.")
      }

      if(!settings || !(settings.secret && settings.key)) {
        throw new Error("CallService must be instantiated with oauth attributes 'key' and 'secret'.");
      }
